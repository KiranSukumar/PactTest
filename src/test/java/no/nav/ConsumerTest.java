...
public class ConsumerTest {
    ...
    void testArticles(MockServer mockServer) throws IOException {
        HttpResponse httpResponse = Request.Get(mockServer.getUrl() + "/getarticles").execute().returnResponse();
        assertEquals(httpResponse.getStatusLine().getStatusCode(), 200);

        httpResponse = Request.Get(mockServer.getUrl() + "/articles.json").execute().returnResponse();
        assertEquals(httpResponse.getStatusLine().getStatusCode(), 200);
    }
    ...
    void testPerson(MockServer mockServer) throws IOException {
        HttpResponse httpResponse = Request.Get(mockServer.getUrl() + "/person.json").execute().returnResponse();
        assertEquals(httpResponse.getStatusLine().getStatusCode(), 200);
    }
}
